...
<form:form method="post" modelAttribute="registerForm" action="${action}">
    ...
    <formElement:formInputBox idKey="register.email"
                              ...
                              mandatory="true"/>
    <formElement:formInputBox idKey="register.mobilePhoneNumberForm"
                              labelKey="register.mobilePhoneNumberForm" path="mobilePhoneNumberForm"
                              inputCSS="form-control"
                              mandatory="true"/>

    <formElement:formInputBox idKey="register.alternativeMailForm"
                              labelKey="register.alternativeMailForm" path="alternativeMailForm" inputCSS="form-control"
                              mandatory="true"/>
    <formElement:formInputBox idKey="register.dateOfBirthForm"
                              labelKey="register.dateOfBirthForm" path="dateOfBirthForm" inputCSS="form-control"
                              mandatory="true"/>
    <formElement:formInputBox idKey="register.emailPreferenceForm"
                              labelKey="register.emailPreferenceForm" path="emailPreferenceForm" inputCSS="form-control"
                              mandatory="true"/>
