package de.hybris.merchandise.core.servicelayer.interceptor;
...
/**
 * Interceptor that prepares {@link CustomerModel} instance before saving.<br> * It checks if customer is internal and adds it to hybrids group if he was not a member yet. If the customer is not * internal, it removes him from hybrids members. *
 */
